...
session_start();
 ...
 //dom1
  $dim1 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=2 and idempleado=$idempl"));
  $dim2 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=3 and idempleado=$idempl"));
  $dim3 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=4 and idempleado=$idempl"));
  $dim4 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=5 and idempleado=$idempl"));
  $dom1 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=1 and idempleado=$idempl"));

 //dom2

  $dim5 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=7 and idempleado=$idempl"));
  $dim6 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=8 and idempleado=$idempl"));
  $dim7 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=9 and idempleado=$idempl"));
  $dim8 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=10 and idempleado=$idempl"));
  $dim9 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=12 and idempleado=$idempl"));
  $dom2 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=6 and idempleado=$idempl"));

//dom3

  $dim10 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=14 and idempleado=$idempl"));
  $dim11 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=15 and idempleado=$idempl"));
  $dim12 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=16 and idempleado=$idempl"));
  $dim13 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=17 and idempleado=$idempl"));
  $dim14 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=18 and idempleado=$idempl"));
  $dim15 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=19 and idempleado=$idempl"));
  $dim16 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=20 and idempleado=$idempl"));
  $dim17 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=21 and idempleado=$idempl"));
  $dom3 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=13 and idempleado=$idempl"));

  //dom4 

  $dim18 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=23 and idempleado=$idempl"));
  $dim19 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=24 and idempleado=$idempl"));
  $dom4 = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=22 and idempleado=$idempl"));

  //total general intra-A

  $total = mysqli_fetch_array($con -> query("SELECT * FROM calificacion where iddimension=55 and idempleado=$idempl"));
?>
 <!DOCTYPE html>
 <html><head>
 	<title></title>
 ...
 <h2 style="text-align: center;background-color: #E6C698">INTRALABORAL - FORMA A</h2>
 <br>
 <hr>
 <br>
 <br><br>
 ...
 <br><br><br><br><br>
  ...
  <h4 style="text-align: center;background-color: #E6C698"><strong>RESULTADOS DEL CUESTIONARIO INTRALABORAL - A</strong></h4>
  <table class="table table-bordered" border="2">
    <tbody>
    <tr >
    ...
    <tr>
     <td rowspan="4" style="text-alingn: center; background-color: #E6C698">Liderazgo y relaciones sociales enel trabajo</td>
    ...
    <tr>
      <td style="background-color: #E6C698">Relación con los colaboradores (subordinados)</td>
    ...
    <tr>
     <td rowspan="8" style="text-alingn: center; background-color: #E6C698">Demandas del trabajo</td>
    ...
    <tr>
      <td style="background-color: #E6C698">Exigencias de responsabilidad del cargo</td>
    ...
    <tr>
      <td style="background-color: #E6C698">Consistencia del rol</td>
    ...
    <tr>
      ...
      <td style="text-align: center;"><?php echo round($dim17[5], 1); ?></td>
      <td style="text-align: center;"><?php echo $dim17[6] ?></td>
    </tr>
    <tr>
    ...
    <tr>
     ...
     <td style="text-align: center;"><?php echo round($dim18[5], 1); ?></td>
      <td style="text-align: center;"><?php echo $dim18[6] ?></td>
    </tr>
    <tr>
      <td style="background-color: #E6C698">Reconocimiento y compensación</td>
      <td style="text-align: center;"><?php echo round($dim19[5], 1); ?></td>
      <td style="text-align: center;"><?php echo $dim19[6] ?></td>
    </tr>
    <tr>
...
PSICOSOCIAL INTRALABORAL - A</strong></td>
  ...
  <br><br><br>
  <label style="background-color: #E6C698">Fecha de elaboración de informe: </label><span> <?php echo date('Y-m-d'); ?></span>
  <br>
  <br>
  <label style="background-color: #E6C698">Firma del evaluador:</label><span>_________________________</span>
 </div>
 </body></html>
<?php  
