...
<body>
	...
	if ($resultado[0]>0 && $resultado2[0]>0){
	    ...
	    $con->query("INSERT into informe_tabla (id_empresa,id_cliente,id_departamento,fecha,nombre_archivo) values ($idempresa,$idcliente,$iddepartamento,'$fecha','$filename')");
	?>	
	...
	function GenerarIntraAB() {
		$.ajax({
		    ...
		    success: function(data) {
				...
				setTimeout(function(){ window.location= '../paginas/informe-tabla.php'; }, 1500);
		    },
