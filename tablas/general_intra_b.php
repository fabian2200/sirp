...
?>
 ...
 <div style="text-align: center;">
  <table>
   ...
   <?php
      $dim1 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=26");
   ...
   <?php  
      $dim2 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=27");
   ...
   <?php  
      $dim3 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=28");
   ...
   <?php  
      $dom1 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=25");
     ...
     $malt=0;
      ...
      $d1 = array("Liderazgo y relaciones sociales en el trabajo y sus dimensiones",round(((($vector[1]+$vector2[1]+$vector3[1])/3)/$NueroEmpleados)*100,1),round(((($vector[2]+$vector2[2]+$vector3[2])/3)/$NueroEmpleados)*100,1),round(((($vector[3]+$vector2[3]+$vector3[3])/3)/$NueroEmpleados)*100,1),round(((($vector[4]+$vector2[4]+$vector3[4])/3)/$NueroEmpleados)*100,1),round(((($vector[5]+$vector2[5]+$vector3[5])/3)/$NueroEmpleados)*100,1));
   ?>
    <tr>
      <td><?php echo $d1[0] ?></td>
      <td><?php echo round(((($vector[1]+$vector2[1]+$vector3[1])/3)/$NueroEmpleados)*100,1)." %"; ?></td>
      <td><?php echo round(((($vector[2]+$vector2[2]+$vector3[2])/3)/$NueroEmpleados)*100,1)." %"; ?></td>
      <td><?php echo round(((($vector[3]+$vector2[3]+$vector3[3])/3)/$NueroEmpleados)*100,1)." %"; ?></td>
      <td><?php echo round(((($vector[4]+$vector2[4]+$vector3[4])/3)/$NueroEmpleados)*100,1)." %"; ?></td>
      <td><?php echo round(((($vector[5]+$vector2[5]+$vector3[5])/3)/$NueroEmpleados)*100,1)." %"; ?></td>
    </tr>
   </table>
  </div>
  <br>
  <p>
   ...
   <?php  
      $dim4 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=30");
   ...
   <?php  
      $dim5 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=31");
   ...
   <?php  
      $dim6 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=32");
   ...
   <?php  
      $dim7 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=33");
   ...
   <?php  
      $dim8 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=35");
     ...
     $malt=0;
      ...
      $vector5 = array("Control y autonomía sobre el trabaj",$malt,$alto,$medi,$bajo,$sinr);
   ...
   <?php  
      $dom2 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=29");
   ...
   <?php  
      $dim9 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=37");
   ...
   <?php  
      $dim10 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=38");
   ...
   <?php  
      $dim11 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=39");
   ...
   <?php  
      $dim12 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=40");
   ...
   <?php  
      $dim13 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=41");
     ...
     $malt=0;
      ...
      $vector5 = array("Demandas de carga mental",$malt,$alto,$medi,$bajo,$sinr);
   ?>
    <tr>
      <td><?php echo $vector5[0] ?></td>
      <td><?php echo $vector5[1] ?></td>
   ...
   <?php  
      $dim14 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=42");
     ...
     $malt=0;
      ...
      $vector6 = array("Demandas de la jornada de trabajo",$malt,$alto,$medi,$bajo,$sinr);
   ?>
    <tr>
   ...
   <?php  
      $dom3 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=36");
     ...
     $malt=0;
      ...
      $d3 = array("Demandas del trabajo",round(((($vector[1]+$vector2[1]+$vector3[1]+$vector4[1]+$vector5[1]+$vector6[1])/6)/$NueroEmpleados)*100,1),round(((($vector[2]+$vector2[2]+$vector3[2]+$vector4[2]+$vector5[2]+$vector6[2])/6)/$NueroEmpleados)*100,1),round(((($vector[3]+$vector2[3]+$vector3[3]+$vector4[3]+$vector5[3]+$vector6[3])/6)/$NueroEmpleados)*100,1),round(((($vector[4]+$vector2[4]+$vector3[4]+$vector4[4]+$vector5[4]+$vector6[4])/6)/$NueroEmpleados)*100,1), round(((($vector[5]+$vector2[5]+$vector3[5]+$vector4[5]+$vector5[5]+$vector6[5])/6)/$NueroEmpleados)*100,1));
      
   ?>
    <tr>
     <td><?php echo $d3[0] ?></td>
      <td><?php echo round(((($vector[1]+$vector2[1]+$vector3[1]+$vector4[1]+$vector5[1]+$vector6[1])/6)/$NueroEmpleados)*100,1)." %"; ?></td>
      <td><?php echo round(((($vector[2]+$vector2[2]+$vector3[2]+$vector4[2]+$vector5[2]+$vector6[2])/6)/$NueroEmpleados)*100,1)." %"; ?></td>
      <td><?php echo round(((($vector[3]+$vector2[3]+$vector3[3]+$vector4[3]+$vector5[3]+$vector6[3])/6)/$NueroEmpleados)*100,1)." %"; ?></td>
      <td><?php echo round(((($vector[4]+$vector2[4]+$vector3[4]+$vector4[4]+$vector5[4]+$vector6[4])/6)/$NueroEmpleados)*100,1)." %"; ?></td>
      <td><?php echo round(((($vector[5]+$vector2[5]+$vector3[5]+$vector4[5]+$vector5[5]+$vector6[5])/6)/$NueroEmpleados)*100,1)." %"; ?></td>
    </tr>
   </table>
  </div>
  <!-- dimension 15 -->
   ...
   <?php  
      $dim15 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=44");
   ...
   <?php  
      $dim16 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=45");
   ...
   <?php  
      $dom4 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=43");
 ...
 <br>
  ...
  <?php  
    $empleados_intra_a = $con->query("SELECT idempleado FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen` in (2) GROUP BY idempleado");
 ...
 <tr>
  ...
  <br>
   <br>
  <br>
 <h5><?php echo 'CONSOLIDADO CUESTIONARIO INTRALABORAL FORMA B POR DEPARTAMENTO O AREA ' .$nombredepartamento; ?></h5>
 </p>
 <div style="text-align: center;">
   <table>
    <tr>
