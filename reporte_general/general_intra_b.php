...
?>
 ...
 <div style="text-align: left;">
  ...
  <br>
  <?php  
    $empleados_intra_a = $con->query("SELECT idempleado FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 GROUP BY idempleado");
  ?>
   <br>
    <p> 
   ...
   <?php  
    ...
    while ($row = mysqli_fetch_array($empleados_intra_a)) {
      //verificar si el empleado tiene extralaboral
