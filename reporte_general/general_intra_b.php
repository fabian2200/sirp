...
?>
 ...
 <head>
 	<title>Intra-B-<?php echo $nombredepartamento; ?>-<?php echo $nombreempresa; ?></title>
 	<meta charset="utf-8">
    ...
    <style type="text/css">
        ...
        .alerta{
            ...
            text-align: center;
            margin-top: 20px;
            background-color:rgb(113, 179, 250);
            color: white;
            border-radius: 10px;
            padding: 10px;
            color: white;
 ...
 <body>
    <div class="container alerta" id="alerta">
        <h3>Estas viendo la vista previa del informe intralaboral forma B de la empresa <strong><?php echo $nombreempresa; ?></strong> en el departamento <strong><?php echo $nombredepartamento; ?></strong>, para descargar el informe, por favor presione el boton de imprimir.</h3>
    ...
    <div style="text-align: left;" class="contenido">
        ...
        <br>
        <h4>RESULTADOS DEL CUESTIONARIO INTRALABORAL FORMA B - <?php echo $nombredepartamento; ?></h4>
        <h4>1.	Tablas de los resultados del Cuestionario Intralaboral Forma B</h4>
        <ul>
            ...
            <li><h5>1.5. Resultado general del Cuestionario Intralaboral Forma B por niveles de riesgo</h5></li>
        </ul>
        <h4>2.	Figuras de los resultados del Cuestionario Intralaboral Forma B</h4>
        <ul>
    ...
    <div style="text-align: left;" class="contenido">
        <ul>
            <li style="padding-left: 10px;"><h5>2.3.5. Dimensión: Demandas de carga mental</h5></li>
            <li style="padding-left: 10px;"><h5>2.3.6. Dimensión: Demandas de la jornada de trabajo</h5></li>
    ...
    <div class="salto"></div>
    <?php
        $dim1 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2  AND `iddimension`=25");
        $dim11 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=26");
        $dim12 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=27");
        $dim13 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=28");
        ...
        $normadim1 = $con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 25");
        ...
        $normadim11 = $con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 26");
        ...
        $normadim12 = $con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 27");
        ...
        $normadim13 = $con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 28");
    ...
    ?>
    <div style="text-align: left;" class="contenido">
        <h3 style="width: 100%; text-align: center;">RESULTADOS DEL CUESTIONARIO INTRALABORAL FORMA B - <?php echo $nombredepartamento; ?></h3>
        <p>A continuación se presentan los resultados de los empleados a los cuales se les aplicó la forma B del Cuestionario Intralaboral, el extralaboral y el estrés.</p>
        <br>
        <p><strong>1. Tablas de los resultados del Cuestionario Intralaboral Forma B</strong></p>
    ...
    <div class="salto"></div>
    <?php
        $dim2 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=29");
        $dim21 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=30");
        $dim22 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=31");
        $dim23 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=32");
        $dim24 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=33");
        $dim25 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=35");
        ...
        $normadim2 = $con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 29");
        ...
        $normadim21 = $con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 30");
        ...
        $normadim22 = $con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 31");
        ...
        $normadim23 = $con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 32");
        ...
        $normadim24 = $con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 33");
        ...
        $normadim25 = $con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 35");
    ...
    <div class="salto"></div>
    <?php
        $dim3 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=36");
        $dim31 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=37");
        $dim32 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=38");
        $dim33 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=39");
        $dim34 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=40");
        $dim35 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=41");
        $dim36 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=42");
    ...
    <div class="salto"></div> 
    <?php
        $dim4 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=43");
        $dim41 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=44");
        $dim42 = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=45");
        ...
        $normadim4 = $con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 43");
        ...
        $normadim41 = $con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 44");
        ...
        $normadim42 = $con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 45");
    ...
    <?php
        $total_intra_b = $puntajeBrutodim1 + $puntajeBrutodim2 + $puntajeBrutodim3 + $puntajeBrutodim4;
        $total_bruto_intra_b = $total_intra_b / $numeroRespuestasDim42;
       
        $total_transformado_intra_b = ($total_bruto_intra_b / 388) * 100;
        $total_transformado_intra_b = round($total_transformado_intra_b, 1);


        if($total_transformado_intra_b >= 0.0 && $total_transformado_intra_b <= 20.6){
            $riesgo_total_intra_b = "Sin riesgo";
        }elseif($total_transformado_intra_b >= 20.7 && $total_transformado_intra_b <= 26.0){
            $riesgo_total_intra_b = "Riesgo bajo";
        }elseif($total_transformado_intra_b >= 26.1 && $total_transformado_intra_b <= 31.2){
            $riesgo_total_intra_b = "Riesgo medio";
        }elseif($total_transformado_intra_b >= 31.3 && $total_transformado_intra_b <= 38.7){
            $riesgo_total_intra_b = "Riesgo alto";
        }elseif($total_transformado_intra_b >= 38.8){
            $riesgo_total_intra_b = "Riesgo muy alto";
        }

        if($total_transformado_intra_b <= 31.2){
            $tiempo_intra_b = "2 años";
        }else{
            $tiempo_intra_b = "1 año";
        }

        $fadimTotalB = array(0,0,0,0,0);

        $totalB = $con -> query("SELECT * FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 AND `iddimension`=56");
        $arrayRiesgoTotalB = formarArrayRiesgo($totalB);
        $fadimTotalB = $arrayRiesgoTotalB[2];        
    ?>
     <div class="salto"></div>
    <script>
        var options = {
    ...
    <div style="text-align: left;" class="contenido">
        <p><strong>1.5. Resultado general del Cuestionario Intralaboral Forma B por niveles de riesgo</strong></p>
        <p><i>Figura 1. Niveles de riesgo en el Cuestionario Intralaboral Forma B - <?php echo $nombreempresa; ?> - <?php echo $nombredepartamento; ?></i></p>
        <br>
        <div style="margin-bottom: 0px; margin-top: 0px; " class="chart-container">
            <canvas id="chart_intra_b"></canvas>
        </div>
        <p style="margin-top: 0px; margin-bottom: 0px;">En el Cuestionario Intralaboral B, con su puntaje transformado de <strong><?php echo $total_transformado_intra_b; ?></strong>, presenta un nivel de <strong><?php echo $riesgo_total_intra_b; ?></strong>, lo cual nos indica de acuerdo con el Artículo 3, de la Resolución 2764 del 18 de julio de 2022, que la siguiente evaluación del riesgo psicosocial debe realizarse dentro de <strong><?php echo $tiempo_intra_b; ?></strong>.</p>
        <script>
            const ctx = document.getElementById('chart_intra_b').getContext('2d');

            const datos = [<?php echo $fadimTotalB[0]; ?>, <?php echo $fadimTotalB[1]; ?>, <?php echo $fadimTotalB[2]; ?>, <?php echo $fadimTotalB[3]; ?>, <?php echo $fadimTotalB[4]; ?>];
    ...
    <div class="salto"></div>
    <div style="text-align: left;" class="contenido">
        <p><strong>2. Figuras de los resultados del Cuestionario Intralaboral Forma B</strong></p>
        <p>En las siguientes figuras, 2 a la 21, se presentan las frecuencias absolutas de empleados en cada uno de los cinco niveles de riesgo para cada una de los cuatro dominios y sus respectivas dimensiones</p>
        <br>
    ...
    <div style="text-align: left;" class="contenido">
        ...
        <i>Figura 6. Niveles de riesgo del dominio: Control sobre el trabajo</i>
        <br>
        <div  style="height: auto !important;" class="chart-container">
    ...
    <div style="text-align: left;" class="contenido">
        ...
        <i>Figura 12. Niveles de riesgo del dominio: Demandas del trabajo</i>
        <br>
        <div  style="height: auto !important;" class="chart-container">
    ...
    <p><strong>2.4. Dominio: Recompensas y sus dimensiones</strong></p>
        <i>Figura 19. Niveles de riesgo del dominio: Recompensas</i>
        <br>
        <div  style="height: auto !important;" class="chart-container">
    ...
    <div class="salto"></div>
    <?php
        $empleados_intra_b = $con->query("SELECT idempleado FROM `calificacion` WHERE `idempresa`=$idempresa and `iddepartamento`=$iddepartamento and `tipo_examen`=2 GROUP BY idempleado");
        ...
        while ($row = mysqli_fetch_array($empleados_intra_b)) { 
        ...
        $puntajeTransformadoDim1Extra = round(($puntajeBrutodim1Extra / $empleados_intra_b->num_rows) / $factorTransformDim1Extra * 100, 1);

        $factorTransformDim2Extra = mysqli_fetch_array($con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 47"))[0];
        $puntajeTransformadoDim2Extra = round(($puntajeBrutodim2Extra / $empleados_intra_b->num_rows) / $factorTransformDim2Extra * 100, 1);

        $factorTransformDim3Extra = mysqli_fetch_array($con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 48"))[0];
        $puntajeTransformadoDim3Extra = round(($puntajeBrutodim3Extra / $empleados_intra_b->num_rows) / $factorTransformDim3Extra * 100, 1);

        $factorTransformDim4Extra = mysqli_fetch_array($con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 49"))[0];
        $puntajeTransformadoDim4Extra = round(($puntajeBrutodim4Extra / $empleados_intra_b->num_rows) / $factorTransformDim4Extra * 100, 1);

        $factorTransformDim5Extra = mysqli_fetch_array($con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 50"))[0];
        $puntajeTransformadoDim5Extra = round(($puntajeBrutodim5Extra / $empleados_intra_b->num_rows) / $factorTransformDim5Extra * 100, 1);

        $factorTransformDim6Extra = mysqli_fetch_array($con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 51"))[0];
        $puntajeTransformadoDim6Extra = round(($puntajeBrutodim6Extra / $empleados_intra_b->num_rows) / $factorTransformDim6Extra * 100, 1);

        $factorTransformDim7Extra = mysqli_fetch_array($con -> query("SELECT factortransform FROM `normas` WHERE `iddi`= 52"))[0];
        $puntajeTransformadoDim7Extra = round(($puntajeBrutodim7Extra / $empleados_intra_b->num_rows) / $factorTransformDim7Extra * 100, 1);
        ...
        $puntajeTransformadoDimExtra = round(($puntajeBrutodimExtra / $empleados_intra_b->num_rows) / $factorTransformDimExtra * 100, 1); 
    ?>
    <div style="text-align: left;" class="contenido">
    ...
    <div style="text-align: left;" class="contenido">
        ...
        <i>Figura 22. Niveles de riesgo del Cuestionario Extralaboral</i>
        <br>
        <div  style="height: auto !important;" class="chart-container">
        ...
        <p>Seguidamente se presentan en las figuras 23 a la 29 los resultados de la aplicación del Cuestionario Extralaboral en sus diferentes dimensiones, expresando el porcentaje de empleados en cada nivel de riesgo</p>
    </div>
    <div class="salto"></div>   
    <div style="text-align: left;" class="contenido">
        <p><strong>3.1. Dimensión: Tiempo fuera del trabajo</strong></p>
        <i>Figura 23. Niveles de riesgo de la dimensión: Tiempo fuera del trabajo</i>
        <br>
        <div  style="height: auto !important;" class="chart-container">
        ...
        <i>Figura 24. Niveles de riesgo de la dimensión: Relaciones familiares</i>
        <br>
        <div  style="height: auto !important;" class="chart-container">
    ...
    <div style="text-align: left;" class="contenido">
        ...
        <i>Figura 25. Niveles de riesgo de la dimensión: Comunicación y relaciones interpersonales</i>
        <br>
        <div  style="height: auto !important;" class="chart-container">
        ...
        <i>Figura 26. Niveles de riesgo de la dimensión: Situación económica del grupo familiar</i>
        <br>
        <div  style="height: auto !important;" class="chart-container">
    ...
    <div style="text-align: left;" class="contenido">
        ...
        <i>Figura 27. Niveles de riesgo de la dimensión: Características de la vivienda y de su entorno</i>
        <br>
        <div  style="height: auto !important;" class="chart-container">
        ...
        <i>Figura 28. Niveles de riesgo de la dimensión: Influencia del entorno extralaboral sobre el trabajo</i>
        <br>
        <div  style="height: auto !important;" class="chart-container">
    ...
    <div style="text-align: left;" class="contenido">
        ...
        <i>Figura 29. Niveles de riesgo de la dimensión: Desplazamiento vivienda - trabajo - vivienda</i>
        <br>
        <div  style="height: auto !important;" class="chart-container">
    ...
    <?php
        ...
        $puntajeTransformadoEstres = round(($puntajeBrutoestres / $empleados_intra_b->num_rows) / $factorTransformEstres * 100, 1);
    ?>   
    <div style="text-align: left;" class="contenido">
        ...
        <i>Figura 30. Niveles de riesgo del Cuestionario del Estrés</i>
        <br>
        <div  style="height: auto !important;" class="chart-container">
